            ...
            <div className="w-full max-w-[450px]  mx-auto">
                ...
                <div>
                    ...
                    <p className="pt-3 text-center text-text-tertiary">
                        We&rsquo;ve sent you an OTP (One-Time Password) to
                        verify your identity and reset your password. Please
                        check your registered email or mobile number for the
                        OTP.
                    </p>
                </div>
